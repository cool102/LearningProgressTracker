    ...
    public void run() {
        ...
        while (true) {
            switch (Utils.getLine()) {
                ...
                case ADD : addStudents();break;
                case LIST : showStudents();break;
                case FIND : findStudents();break;
                case ADD_P : addPoints();break;
                case STAT : getStats();break;
                case NOTIFY : getNotify();break;
                case "" : System.out.println("No input.");break;
                case EXIT : {
